  ...
  Route::group(['middleware' =>['auth']], function() {
    ...
    */
    ...
    Route::group(['middleware' => ['email_verified']], function() {
         ...
         */
        //Food Category Links
        Route::get('/foodCategory', [CategoryController::class, 'categoryShow'])->name('admin.category');
        ...
        Route::get('/foodMenu', [ProductController::class, 'showProducts'])->name('admin.products');
         ...
         * Paystack Routes
         */
        Route::post('/payment', [PaymentController::class, 'redirectToGateway'])->name('pay.now');
