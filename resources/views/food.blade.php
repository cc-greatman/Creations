                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-price">
                                                ...
                                                @if ($food->discount_price != null)
                                                 <del style="color: rgb(210, 15, 15)">₦{{ $food->price }}</del>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-info">
                                            ...
                                            <h3>{{ $meals->title }}</h3>
                                            <div class="product-price">
                                                @if ($meals->discount_price)
                                                    <span>₦{{ $meals->discount_price }}</span>
                                                @else
                                                 <span>₦{{ $meals->price }}</span>
                                                @endif
                                                @if ($meals->discount_price != null)
                                                 <del style="color: rgb(210, 15, 15)">₦{{ $meals->price }}</del>
                                                @endif
                                            </div>
