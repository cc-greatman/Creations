                                                ...
                                                <div class="flex flex-wrap justify-between items-center mb-4">
                                                    ...
                                                    <div>
                                                        @if($food->discount_price)
                                                            <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">₦{{ $food->discount_price }}</div>
                                                        @elseif(!$food->discount_price)
                                                    ...
                                                    <div>
                                                        @if($food->discount_price)
                                                            <div class="inline-flex text-sm font-medium bg-rose-100 text-rose-600 rounded-full text-center px-2 py-0.5"><s>₦{{ $food->price }}</s></div>
                                                        @endif
                                                    </div>
                                                </div>
                                                <!-- Features list -->
